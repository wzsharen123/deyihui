    ...
    <div class="pagebefor">
      <template>
        ...
        >
          ...
          <el-table-column label="找药医生" width="120">
            <template slot-scope="scope">{{ scope.row.date }}</template>
          </el-table-column>
          <el-table-column prop="name" label="药品名称" width="120" />
          <el-table-column prop="address" label="规格" show-overflow-tooltip />
          <el-table-column
            prop="address"
            label="功能主治"
            show-overflow-tooltip
          />
          <el-table-column prop="address" label="图片" show-overflow-tooltip />
          <el-table-column
            prop="address"
            label="申请时间"
            show-overflow-tooltip
