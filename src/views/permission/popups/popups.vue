  ...
  <div class="allzong">
    <div class="chresh">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item label="选择地区" prop="desc">
          <diqu />
        </el-form-item>
        <el-form-item>
    ...
    <div class="pagebefor">
      ...
      <el-dialog :visible.sync="dialogFormVisible">
        <el-form
          ...
          class="demo-ruleForm"
        >
          <el-form-item label="医院名称" prop="name" hide-required-asterisk="false">
            <el-input v-model="ruleForm.name" />
          </el-form-item>
          <el-form-item label="医院简称" prop="name">
            <el-input v-model="ruleForm.name" />
          </el-form-item>

          <el-form-item label="医院简介" prop="desc">
